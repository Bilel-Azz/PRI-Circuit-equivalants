...
class TransformerDecoderV2(nn.Module):
    """
    Decoder V2: node_b is forced different from node_a via masking.
    Eliminates self-loop possibilities.
    """
    ...
    def __init__(
        ...
        # node_b conditioned on hidden state + node_a one-hot
    ...
    def _generate_autoregressive(
        ...
        for t in range(1, self.max_seq_len):
            ...
            # node_b conditioned on node_a, with masking to prevent self-loops
